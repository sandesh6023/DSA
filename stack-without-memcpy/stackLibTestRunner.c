...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_push_string_into_stack");
	setup();
		test_push_string_into_stack();
	tearDown();
	testEnded();
	testStarted("test_push_element_into_intStack_should_extend_stack_inCase_of_stackOverflow");
	setup();
		test_push_element_into_intStack_should_extend_stack_inCase_of_stackOverflow();
	tearDown();
	testEnded();
